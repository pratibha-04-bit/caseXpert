...
def get_reputation(alert_type, alert_value):
    ...
    return None, None
APT_SOURCES = [
    {"name": "ThreatFox", "url": "https://threatfox-api.abuse.ch/api/v1/", "payload": {"query": "search_hash", "api_key":}},
...
def filter_apt_data(source_name, data):
    if source_name == "ThreatFox":
        ...
        return {
            ...
            "file_name": data.get("data", [{}])[0].get("file_name"),
